...
public class ItemModelManager {
	...
	public static File getItemArmorTextureFolder(Addon addon) {
		File textureFolder = new File(addon.addonFolder, "assets" + File.separator + "wys" + File.separator + "textures" + File.separator + "models" + File.separator + "armor");
	...
	public static File getItemHatOverlayTextureFolder(Addon addon) {
		File textureFolder = new File(addon.addonFolder, "assets" + File.separator + "wys" + File.separator + "textures" + File.separator + "overlays");
	...
	public static File getItemModelFolder(Addon addon) {
		File modelFolder = new File(addon.addonFolder, "assets" + File.separator + "wys" + File.separator + "models" + File.separator + "item");
	...
	public static File getItemTextureFolder(Addon addon) {
		File textureFolder = new File(addon.addonFolder, "assets" + File.separator + "wys" + File.separator + "textures" + File.separator + "items");
