...
import cf.wyslmzc.yuhao.additions.util.models.ItemModelManager.ItemBlockModelType;
...
public class BlockModelManager {
	...
	public static File getBlockStateFolder(Addon addon) {
		File modelFolder = new File(addon.addonFolder, "assets" + File.separator + "wys" + File.separator + "blockstates");
	...
	public static File getBlockModelFolder(Addon addon) {
		File modelFolder = new File(addon.addonFolder, "assets" + File.separator + "wys" + File.separator + "models" + File.separator + "block");
	...
	public static File getBlockTextureFolder(Addon addon) {
		File textureFolder = new File(addon.addonFolder, "assets" + File.separator + "wys" + File.separator + "textures" + File.separator + "blocks");
