package cf.wyslmzc.yuhao.additions.util.client;
...
public class CommonGuiUtils {
	...
	public static final ResourceLocation GUI_TEXTURES = new ResourceLocation(AdditionsMod.MOD_NAME + ":textures/gui/additions_gui_textures.png");
