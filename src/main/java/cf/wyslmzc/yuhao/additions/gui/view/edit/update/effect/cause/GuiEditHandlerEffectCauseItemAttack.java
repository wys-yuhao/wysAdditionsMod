...
/**
 * Creates components and handles saving the item attack effect cause.
 * 
 * @author Rebeca Rey (Tmtravlr)
 * @date June 2019
 */
public class GuiEditHandlerEffectCauseItemAttack implements IGuiEffectCauseEditHandler {
	...
	public List<IGuiViewComponent> createViewComponents(GuiEdit editScreen, EffectCause cause) {
		...
		EffectCauseItemAttack specificCause = (cause instanceof EffectCauseItemAttack) ? (EffectCauseItemAttack) cause : null;
		
		this.description = new GuiComponentDisplayText(editScreen, new TextComponentTranslation("type.effectCause.itemAttack.description"));
	...
	public EffectCause createEffectCause() {
		...
		EffectCauseItemAttack cause = new EffectCauseItemAttack();
