...
public class GuiMessageBoxNeedsRestart extends GuiMessageBoxTwoButton {

	public GuiMessageBoxNeedsRestart(GuiScreen parentScreen, String title, ITextComponent message) {
