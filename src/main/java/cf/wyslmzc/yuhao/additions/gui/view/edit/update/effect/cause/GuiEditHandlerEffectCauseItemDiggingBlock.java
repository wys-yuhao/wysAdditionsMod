...
/**
 * Creates components and handles saving the item digging block effect cause.
 * 
 * @author Rebeca Rey (Tmtravlr)
 * @date June 2019
 */
public class GuiEditHandlerEffectCauseItemDiggingBlock implements IGuiEffectCauseEditHandler {
	...
	public List<IGuiViewComponent> createViewComponents(GuiEdit editScreen, EffectCause cause) {
		...
		EffectCauseItemDiggingBlock specificCause = (cause instanceof EffectCauseItemDiggingBlock) ? (EffectCauseItemDiggingBlock) cause : null;
		
		this.description = new GuiComponentDisplayText(editScreen, new TextComponentTranslation("type.effectCause.itemDigging.description"));
	...
	public EffectCause createEffectCause() {
		...
		EffectCauseItemDiggingBlock cause = new EffectCauseItemDiggingBlock();
