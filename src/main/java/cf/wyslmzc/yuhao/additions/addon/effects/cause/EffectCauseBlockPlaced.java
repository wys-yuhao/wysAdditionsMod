...
/**
 * Cause for placing a block.
 * 
 * @author Rebeca Rey (Tmtravlr)
 * @date May 2021
 */
public class EffectCauseBlockPlaced extends EffectCauseBlock {
	public static final ResourceLocation TYPE = new ResourceLocation(AdditionsMod.MOD_ID, "block_placed");
	...
	public static class Serializer extends EffectCause.Serializer<EffectCauseBlockPlaced> {
		
		public Serializer() {
			super(TYPE, EffectCauseBlockPlaced.class);
		}
		
		@Override
		public JsonObject serialize(EffectCauseBlockPlaced effectCause, JsonSerializationContext context) {
		...
		@Override
		public EffectCauseBlockPlaced deserialize(JsonObject json, JsonDeserializationContext context) {
			EffectCauseBlockPlaced effectCause = new EffectCauseBlockPlaced();
