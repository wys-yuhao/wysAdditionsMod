...
/**
 * Cause for digging a block.
 * 
 * @author Rebeca Rey (Tmtravlr)
 * @date May 2021
 */
public class EffectCauseBlockDigging extends EffectCauseBlock {
	public static final ResourceLocation TYPE = new ResourceLocation(AdditionsMod.MOD_ID, "block_digging");
	...
	public static class Serializer extends EffectCause.Serializer<EffectCauseBlockDigging> {
		
		public Serializer() {
			super(TYPE, EffectCauseBlockDigging.class);
		}
		
		@Override
		public JsonObject serialize(EffectCauseBlockDigging effectCause, JsonSerializationContext context) {
		...
		@Override
		public EffectCauseBlockDigging deserialize(JsonObject json, JsonDeserializationContext context) {
			EffectCauseBlockDigging effectCause = new EffectCauseBlockDigging();
