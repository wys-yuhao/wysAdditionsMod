...
public class BlockAddedPane extends BlockPane implements IBlockAdded {
	...
	public static class Serializer extends IBlockAdded.Serializer<BlockAddedPane> {
		...
		public Serializer() {
			super(TYPE, BlockAddedPane.class);
		}
		
		@Override
		public BlockAddedPane deserialize(JsonObject json, JsonDeserializationContext context) {
			BlockAddedPane blockAdded = new BlockAddedPane();
