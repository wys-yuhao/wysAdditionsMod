...
/**
 * Cause for an entity updating.
 * 
 * @author Rebeca Rey (Tmtravlr)
 * @date May 2021
 */
public class EffectCauseEntityUpdate extends EffectCauseEntity {
	public static final ResourceLocation TYPE = new ResourceLocation(AdditionsMod.MOD_ID, "entity_update");
	
	public boolean applies(Entity entity) {
		return this.entityMatches(entity);
	}

	public static class Serializer extends EffectCause.Serializer<EffectCauseEntityUpdate> {
		
		public Serializer() {
			super(TYPE, EffectCauseEntityUpdate.class);
		}
		
		@Override
		public JsonObject serialize(EffectCauseEntityUpdate effectCause, JsonSerializationContext context) {
		...
		@Override
		public EffectCauseEntityUpdate deserialize(JsonObject json, JsonDeserializationContext context) {
			EffectCauseEntityUpdate effectCause = new EffectCauseEntityUpdate();
