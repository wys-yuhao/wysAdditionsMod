 ...
 * @date June 2019
 */
public class EffectCauseItemKill extends EffectCauseItem {
	public static final ResourceLocation TYPE = new ResourceLocation(AdditionsMod.MOD_ID, "item_kill");
	...
	public static class Serializer extends EffectCause.Serializer<EffectCauseItemKill> {
		
		public Serializer() {
			super(TYPE, EffectCauseItemKill.class);
		}
		
		@Override
		public JsonObject serialize(EffectCauseItemKill effectCause, JsonSerializationContext context) {
		...
		@Override
		public EffectCauseItemKill deserialize(JsonObject json, JsonDeserializationContext context) {
			EffectCauseItemKill effectCause = new EffectCauseItemKill();
